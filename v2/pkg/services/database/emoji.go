...
func (s *Service) UpdateEmojiList(force bool) (time.Time, error) {
...
func (s *Service) GetEmojiList() []models.CustomEmoji {
	_, err := s.UpdateEmojiList(false)
	if err != nil {
		return nil
	}
...
func (s *Service) SetupEmojiDirectory() (err error) {
